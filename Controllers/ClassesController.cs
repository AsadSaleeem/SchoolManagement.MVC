...
namespace SchoolManagement.MVC.Controllers
{
    ...
    public class ClassesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Class_Id,Id,CourseId")] Classes classes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Class_Id,Id,CourseId")] Classes classes)
        {
            if (id != classes.Id)
            {
                return NotFound();
